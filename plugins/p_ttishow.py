    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            k = await message.reply(
                text='<b>CHAT NOT ALLOWED 🐞\n\nMy Admins Has Restricted Me From WOrking Here ! If You Want To Know More About It Contact Support Chat</b>',
        ...
        await message.reply_text(
            text=f"<b>ThankYou For Adding Me In {message.chat.title} ❣️\n\nIf You Have Any Questions / Doubts About Using Me Contact Support Chat</b>",
            reply_markup=reply_markup)
    else:
...
async def leave_a_chat(bot, message):
    ...
    try:
        ...
        await bot.send_message(
            chat_id=chat,
            text='<b>Hello Friends, \nMy Admin Has Told Me To Leave From Group So I Go !!! If You Wanna Add Me Again Or Contact My Support Chat.</b>',
            reply_markup=reply_markup,
        )
